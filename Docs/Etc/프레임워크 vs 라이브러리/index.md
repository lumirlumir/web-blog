...
React의 Life Cycle을 살펴보자. Render 과정의 Life Cycle을 예시로 했을 때, 순서는 다음과 같다.
...
홈페이지에 명시된 바와 같이 Express.js는 웹 프레임워크이다. 가볍고 빠르다. Node.js의 견고한 비동기 통신 지원의 장점을 활용한다. 쉽게 적용 가능한 웹 앱과 REST API를 쓸 수 있다.
